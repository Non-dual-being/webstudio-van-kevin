...
Controleer altijd of de actieve branch past bij het werk dat je uitvoert. Commitnummers veranderen na iedere commit. Ga niet pullen, wisselen of verwijderen wanneer `git status --short` onverwachte regels toont.
